...
export function BrainScanPreview({
  ...
  return (
    <div className="overflow-hidden rounded-3xl border border-steel-900 bg-white shadow-card">
      ...
      <div className="relative aspect-[4/3] bg-[radial-gradient(circle_at_50%_40%,rgba(0,0,0,0.08),transparent_54%)] p-6">
        <svg viewBox="0 0 420 300" className="h-full w-full">
          ...
          <circle cx="267" cy="155" r="14" fill="#ffffff" opacity="0.35" />
          <circle cx="267" cy="155" r="42" fill="none" stroke="#171717" strokeWidth="2.5" strokeDasharray="8 8" opacity="0.45" />
        ...
        <div className="absolute left-8 top-8 rounded-2xl border border-steel-900 bg-white px-4 py-3 shadow-soft">
