  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8 lg:py-10">
      <PageHeader
        ...
        description="Capture the structured clinical context needed to support the mock stroke assessment. The form is optimized for speed and clarity at the bedside."
      />
      ...
      <form className="mt-8 space-y-6" onSubmit={submitForm}>
            ...
            <Card className="bg-medical-50/70">
              <CardContent className="space-y-4 p-6">
                ...
                <div className="space-y-2 text-sm text-steel-700">
                  <div className="flex items-center justify-between gap-4"><span className="text-steel-500">Name</span><span className="font-medium">{patient.name || 'Not entered'}</span></div>
                  <div className="flex items-center justify-between gap-4"><span className="text-steel-500">Age</span><span className="font-medium">{patient.age || '—'}</span></div>
                  <div className="flex items-center justify-between gap-4"><span className="text-steel-500">Symptoms</span><span className="font-medium text-right">{patient.symptoms || '—'}</span></div>
                </div>
              </CardContent>
            </Card>
          </div>
        ...
        <div className="flex flex-col gap-3 sm:flex-row sm:justify-end">
          <Button type="button" variant="outline" onClick={() => navigate('/')}>Back to landing</Button>
          <Button type="submit">Continue to scan upload</Button>
        </div>
      </form>
    </div>
  )
